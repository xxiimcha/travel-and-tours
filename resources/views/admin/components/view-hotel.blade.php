...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-muted">Hotel Services Details</h1>
    ...
    $.ajax({
        url: `/api/view-hotel/${bookingId}`, // Your API endpoint
        type: 'GET',
        headers: {
        ...
        success: function(response) {
            ...
            var price = response.hotel_price; // Assuming price is a number in the response
            var formattedPrice = formatNumber(price); // Format the price

            $('.card-title').text(response.hotel_name); // Product Name
            $('.card-subtitle').text('PHP ' + formattedPrice); // Formatted Price
            $('#ex1-pills-1').html(response.hotel_description); // Description
            $('#ex1-pills-2').html(response.hotel_policy); // Policy
            $('#ex1-pills-3').html(response.hotel_included); // Included
