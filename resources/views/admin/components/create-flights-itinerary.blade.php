...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <form action="{{route('create_flights_itinerary')}}" method="POST" enctype="multipart/form-data">
                @csrf
           ...
           @enderror" >
            ...
            <option value="{{ $flights->id }}-{{ $flights->flights_title }}">{{ $flights->flights_title }}</option>
        @endforeach    
           </select>
