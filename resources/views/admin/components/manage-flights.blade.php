    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
           ...
           <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="mb-3">
                        <h1 class="h3 mb-0 text-muted float-start">Manage Flights Service</h1>
                ...
                <div class="col-md-6 ">
                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                        ...
                        <div>
                            <a href="{{ route('create-flights') }}" class="btn  btn-sm btn-primary"><i class="bx bx-plus"></i> Add New Flights Service</a>
                        </div>
                        <div class="dropdown">
                ...
                <table id="destination-table" class="table table-striped table-hover table-bordered align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th scope="col" class="text-center text-muted">Title</th>
                            <th scope="col" class="text-center text-muted">From</th>
                            <th scope="col" class="text-center text-muted">To</th>
                            <th scope="col" class="text-center text-muted">Price</th>
                            <th scope="col" class="text-center text-muted">Description</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: '/api/view-flights-api',  // Your API endpoint
            type: 'GET',
            headers: {
            ...
            success: function(response) {
                ...
                if (response.length === 0) {
                   ...
                   // Base URL for images in the public/flights_images directory
            var baseImageUrl = '/flights-images/';
                     // <td class="text-center text-muted">
                            //  <img src="${baseImageUrl + booking.flights_images}" alt="Flight Image" style="width: 100px; height: auto;">
                            // </td>
                ...
                $.each(response, function(index, booking) {
                    var row = `
                        <tr class="bg-light">
                            ...
                            <td class="text-center text-muted">${booking.flights_title}</td>
                            <td class="text-center text-muted">${booking.flights_from}</td>
                            <td class="text-center text-muted">${booking.flights_to}</td>
                            <td class="text-center text-muted">${booking.flights_price}</td>
             <td class="text-center text-muted">
                    ${booking.flights_description.length > 50 ? booking.flights_description.substring(0, 20) + '...' : booking.flights_description}
                </td>
                            <td class="text-center" >
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="/view-flights/${booking.id}" class="btn btn-sm btn-success" title="View Details">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="#" onclick="deleteBooking(${booking.id})" class="btn btn-sm btn-danger">
                                            <i class="bi bi-trash"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="/edit-flights/${booking.id}"  class="btn btn-sm btn-warning">
  ...
  window.deleteBooking = function(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: `/api/delete-flights-api/${id}`,  // API endpoint for deletion
                        type: 'POST',
                        headers: {
                        ...
                        success: function(response) {
                            Swal.fire({
                                title: 'Deleted!',
                                text: 'Flights deleted successfully.',
                                icon: 'success',
