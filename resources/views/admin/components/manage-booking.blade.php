    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
           ...
           <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="mb-3">
                        <h1 class="h3 mb-0 text-muted float-start">Manage Car Rental</h1>
                ...
                <div class="col-md-6 ">
                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                        ...
                        <div>
                            <a href="{{ route('create_booking') }}" class="btn  btn-sm btn-primary"><i class="bx bx-plus"></i> Add New Car Service</a>
                        </div>
                        <div class="dropdown">
                ...
                <table id="destination-table" class="table table-striped table-hover table-bordered align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th scope="col" class="text-muted">Car type</th>
                            <th scope="col" class="text-muted">Manufacturer</th>
                            <th scope="col" class="text-muted">Price</th>
                            <th scope="col" class="text-muted">Capacity</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: '/api/view-booking-api',  // Your API endpoint
            type: 'GET',
            headers: {
                ...
                $.each(response, function(index, booking) {
                    var row = `
                        <tr class="bg-light">
                            ...
                            <td class="text-center text-muted">${booking.Car_type}</td>
                            <td class="text-center text-muted">${booking.Manufacturer}</td>
                            <td class="text-center text-muted">${booking.Car_price}</td>
                            <td class="text-center text-muted">${booking.Capacity}</td>
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="/view-booking/${booking.id}" class="btn btn-sm btn-success" title="View Details">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="/edit-booking/${booking.id}"  class="btn btn-sm btn-warning">
  ...
  window.deleteBooking = function(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: `/api/delete-booking-api/${id}`,  // API endpoint for deletion
                        type: 'POST',
                        headers: {
