...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-6">
        <!-- Back Button -->
        <a href="{{ route('tour-package') }}" class="bg-blue-400 text-white hover:bg-blue-500 mb-4 inline-block text-sm p-1 rounded">
            &larr; Go Back
        </a>
        ...
        <div class="flex flex-wrap md:flex-nowrap">
            ...
            <div class="w-full md:w-1/2 bg-white rounded-lg shadow-lg p-6 mb-6 md:mb-0">
                ...
                <div class="relative">
                    @if ($data->first_image)
                    <img src="{{ asset('destination-images/' . $data->first_image) }}" alt="Package Image" class="w-full h-full object-cover">
                        @else
                    ...
                    <div class="absolute top-2 right-2 bg-blue-500 text-white font-medium px-3 py-1 text-sm rounded-md">
                        PHP {{ number_format($data->destination_price) }} / {{ $data->destination_days }} Days
                    </div>
                    ...
                    <div class="absolute top-10 right-2 bg-black bg-opacity-50 text-white font-medium px-3 py-1 text-sm rounded-md">
                        Tour Name: {{ $data->destination_name }}
                    </div>
            
                </div>
    
                <!-- Tour Details -->
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Tour Description</h2>
                <p class="text-gray-600 mb-4">
                        {!!  $data->destination_description !!}
                </p>
    
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Tour Policy</h3>
                <p class="text-gray-600 mb-4">
                    {!!  $data->destination_policy!!}
                </p>
                
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Tour Included</h3>
                <p class="text-gray-600 mb-4">
            ...
            <div class="w-full md:w-1/2 ml-0 md:ml-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    @foreach ($images as $index => $image)
                        <img src="{{ asset('destination-images/' . $image) }}" class="w-full h-40 object-cover rounded-md cursor-pointer transition duration-300 transform hover:scale-105" alt="Gallery Image {{ $index + 1 }}" onclick="openModal({{ $index }})">
                    @endforeach
                </div>
            </div>
 ...
 <header class="relative bg-indigo-600 text-white">
    ...
    <div class="relative container mx-auto px-4 py-16 text-center">
      ...
      <p class="mt-4 text-lg md:text-xl">
        Explore the best selection of vacation packages in the Philippines. With all the details arranged for you in advance, you can enjoy a stress-free holiday at top beaches and islands in the country. Book now for the best rates!
      </p>
  ...
  <section class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2">  
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white shadow-md rounded-lg p-6 mb-6">
          ...
          <div>
            <img src="{{asset('daily-itenirary-images/'. $itinerarys->itenirary_images)}}" alt="Day 1 Image" class="w-full rounded-lg">
          </div>
        </div>
      @endforeach
      </div>
    ...
    {{-- <section class="bg-gray-200 py-8">
      <div class="container mx-auto px-4">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Photo Gallery</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <img src="https://via.placeholder.com/300x200" alt="Gallery Image 1" class="rounded-lg">
          <img src="https://via.placeholder.com/300x200" alt="Gallery Image 2" class="rounded-lg">
          <img src="https://via.placeholder.com/300x200" alt="Gallery Image 3" class="rounded-lg">
          <img src="https://via.placeholder.com/300x200" alt="Gallery Image 4" class="rounded-lg">
          <img src="https://via.placeholder.com/300x200" alt="Gallery Image 5" class="rounded-lg">
          <img src="https://via.placeholder.com/300x200" alt="Gallery Image 6" class="rounded-lg">
        </div>
      </div>
    </section> --}}
...
<script>
    ...
    function openModal(index) {
        ...
        setTimeout(() => {
            modalImage.src = "{{ asset('destination-images/') }}/" + images[currentIndex];
