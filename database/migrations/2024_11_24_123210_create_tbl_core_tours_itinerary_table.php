...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_core_tours_itinerary', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tour_id')->constrained('tbl_core_tour')->onDelete('cascade'); // Foreign key to tbl_core_tours
    ...
    {
        Schema::dropIfExists('tbl_core_tours_itinerary');
    }
};
